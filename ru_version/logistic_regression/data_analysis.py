...
# =============================================================================
print('=' * 80)
print('1. Загрузка и первичное исследование данных об удовлетворённости '
      'полётом')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('2. Формирование обучающей и тестовой выборки')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('4. Определение типов факторов')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('5. Анализ взаимосвязей между численными факторами и удовлетворённостью')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('6. Анализ взаимосвязей между категориальными факторами и '
      'удовлетворённостью')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('7. Анализ взаимосвязей между категориальными факторами')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('8. Отбор финального набора факторов')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('9. Подготовка данных для моделирования')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('10. Вывод подготовленных данных')
print('=' * 80)
sleep(2)
...
# =============================================================================
print('\n\n' + '=' * 80)
print('11. Сохранение обучающей и тестовой выборок в CSV файл')
print('=' * 80)
sleep(2)
